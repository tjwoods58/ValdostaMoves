...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { description: @tip.description, image_url: @tip.image_url, type: @tip.type }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { description: @tip.description, image_url: @tip.image_url, type: @tip.type }
    assert_redirected_to tip_path(assigns(:tip))
  end
